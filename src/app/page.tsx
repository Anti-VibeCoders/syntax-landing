...
export default function Home() {
  ...
  return (
    <main
      className="h-dvh flex items-end justify-start overflow-hidden p-8 bg-[url(../../public/background.png)] bg-fixed bg-no-repeat bg-fixed bg-cover bg-center select-none"
      draggable={false}
    >
      <h1
        ref={textHeroRef}
